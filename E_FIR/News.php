...
<body>
    ...
    <section class="header">
        ...
        <center>
            <b>
            <label style="font-size:1.5em;" >There Is No Any New Notice</label> <br>
    ...
    <section class="footer">
        ...
        <h4><a href="PDF/T_And_C.pdf" target="_blank">Terms & Conditions</a></h4>
        <h4><a href="PDF/F_And_Q.pdf" target="_blank">FAQ</a></h4>
        <h4><a href="PDF/P_And_p.pdf" target="_blank">Privacy Policy</a></h4>
        <h4><a href="feedback.php" target="">Feedback</a></h4>
